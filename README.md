...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yaqd-rgb-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13035&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yaqd-rgb-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yaqd-rgb` can be installed with:

```
conda install yaqd-rgb
```

It is possible to list all of the versions of `yaqd-rgb` available on your platform with:
